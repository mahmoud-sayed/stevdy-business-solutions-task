...
const TestimonialCard = ({ item }) => {
  ...
  return (
    <Paper sx={{ boxShadow: '3px 3px 1rem #c2c2c2, -3px -3px 1rem #c2c2c2' }} p={0}>
      <Grid container p={1} direction={{ xs: 'column', sm: 'row', md: 'row' }} justifyContent='center' alignItems='center'>
